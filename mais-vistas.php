<?php
/**
 Template name: Imagens populares
 */
...
<?php endif; ?>                  
            ...
            <div class="container margin-top margin-bottom">
                <div class="row justify-content-center text-align-center">
                    <h1>as imagens que fazem sucesso</h1>
                </div>
            </div>
...
wp_reset_postdata();
            ...
            <div class="container">
                ...
                <div class="row justify-content-center text-align-center margin-bottom">
                    ...
                    <p>Estamos sempre atualizando o acervo da Stock Entre Nuvens, mas queremos te dar novas possibilidades. Se ainda não encontrou o que queria, você pode entrar em contato com a gente para <a href="<?php echo esc_url( home_url( '/' ) ); ?>orcamento">pedir um orçamento</a> e assim vamos produzir o conteúdo que falta exclusivamente para você.</p>
